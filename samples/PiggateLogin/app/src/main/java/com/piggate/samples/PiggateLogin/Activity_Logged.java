...
public class Activity_Logged extends Activity {
    ...
    public void onStart(){
        super.onStart();
        _piggate.onStart(); //Uses the method onStart of Piggate
    }

    //Method onStop of the activity
    @Override
    public void onStop(){
        _piggate.onStop(); //Uses the method onStart of Piggate
        super.onStop();
    }
    ...
    public void onDestroy(){
        _piggate.onDestroy(); //Uses the method onStart of Piggate
        super.onDestroy();
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        _piggate.onActivityResult(requestCode, resultCode, data); //Uses the method onActivityResult of Piggate
    }
