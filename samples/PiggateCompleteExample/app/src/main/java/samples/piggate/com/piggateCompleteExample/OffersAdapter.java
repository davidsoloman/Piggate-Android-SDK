...
public class OffersAdapter extends RecyclerView.Adapter<OffersAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder viewHolder, int i) {
            ...
            viewHolder.offerPrice.setText(offers.get(i).getPrice().toString() + " €");
        }
        ...
        public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
            ...
            public ViewHolder(View itemView) {
                ...
                offerPrice.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) { //Start the buyOffer Activity
                ...
                //OnClick listener for the Google Maps button
                mapsButton.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) { //Starts Google Maps to show the store location
